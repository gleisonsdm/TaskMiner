...
void DFSAboveVCG(nodeVCGType *VCG,
                 ulong net) {
  ulong s;
  ulong above;
...
void DFSBelowVCG(nodeVCGType *VCG,
                 ulong net) {
  ulong s;
  ulong below;
...
void SCC_DFSAboveVCG(nodeVCGType *VCG,
                     ulong net,
                     ulong *label) {
  ulong s;
  ulong above;
...
void SCC_DFSBelowVCG(nodeVCGType *VCG,
                     ulong net,
                     ulong label) {
  ulong s;
  ulong below;
...
void RemoveConstraintVCG(nodeVCGType *VCG,
                         ulong *SCC,
                         ulong *perSCC,
...
ulong ExistPathAboveVCG(nodeVCGType *VCG,
                        ulong above,
                        ulong below) {
  DFSClearVCG(VCG);
  DFSAboveVCG(VCG, above);
...
void LongestPathVCG(nodeVCGType *VCG,
                    ulong net) {
  ulong track;
  ulong bot;
  ulong top;
...
ulong DFSAboveLongestPathVCG(nodeVCGType *VCG,
                             ulong net) {
  ulong s;
  ulong above;
  ulong path;
...
ulong DFSBelowLongestPathVCG(nodeVCGType *VCG,
                             ulong net) {
  ulong s;
  ulong below;
  ulong path;
