...
{                                      /*  begin calcMetricsData()  */
  ...
  if (metrics->insertCommandMetric.numOfCommands > 0) {
    /*
         ...
         *  deviation.
         */
    metrics->insertCommandMetric.avg = metrics->insertCommandMetric.sum / metrics->insertCommandMetric.numOfCommands;
    temp = metrics->insertCommandMetric.sumSquares - metrics->insertCommandMetric.sum * metrics->insertCommandMetric.sum / metrics->insertCommandMetric.numOfCommands;
    if (temp < 0.0) {
  ...
  if (metrics->queryCommandMetric.numOfCommands > 0) {
    metrics->queryCommandMetric.avg = metrics->queryCommandMetric.sum / metrics->queryCommandMetric.numOfCommands;
    temp = metrics->queryCommandMetric.sumSquares - metrics->queryCommandMetric.sum * metrics->queryCommandMetric.sum / metrics->queryCommandMetric.numOfCommands;
    if (temp < 0.0) {
  ...
  if (metrics->deleteCommandMetric.numOfCommands > 0) {
    metrics->deleteCommandMetric.avg = metrics->deleteCommandMetric.sum / metrics->deleteCommandMetric.numOfCommands;
    temp = metrics->deleteCommandMetric.sumSquares - metrics->deleteCommandMetric.sum * metrics->deleteCommandMetric.sum / metrics->deleteCommandMetric.numOfCommands;
    if (temp < 0.0) {
