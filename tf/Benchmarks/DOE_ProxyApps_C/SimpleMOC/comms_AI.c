...
void fast_transfer_boundary_fluxes(Params params, Input I, CommGrid grid) {
  ...
  if (I.mype == 0)
    printf("Beginning Inter-Node Border Flux Transfer...\n");
  ...
  long remaining_tracks = I.ntracks - 2 * ntracks_per_axial_direction - 4 * ntracks_per_radial_direction;
  ...
  if (I.mype == 0)
    printf("Finished Inter-Node Border Flux Transfer.\n");
}
#endif
