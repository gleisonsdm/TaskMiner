...
int hypre_CSRMatrixSetDataOwner(hypre_CSRMatrix *matrix,
                                int owns_data) {
  int ierr = 0;
...
int hypre_CSRMatrixPrint(hypre_CSRMatrix *matrix,
                         char *file_name) {
  FILE *fp;
