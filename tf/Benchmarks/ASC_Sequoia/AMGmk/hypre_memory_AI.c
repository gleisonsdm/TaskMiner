...
#define _umalloc_(size) (threadid == hypre_NumThreads) ? (char *)malloc(size) : (char *)_umalloc(_uparam[threadid].myheap, size)
#define _ucalloc_(count, size) (threadid == hypre_NumThreads) ? (char *)calloc(count, size) : (char *)_ucalloc(_uparam[threadid].myheap, \
                                                                                                               count, size)
#define _urealloc_(ptr, size) (threadid == hypre_NumThreads) ? (char *)realloc(ptr, size) : (char *)_urealloc(ptr, size)
