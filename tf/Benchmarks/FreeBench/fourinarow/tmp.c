...
int find_winner_c(char b[COLS][ROWS + 1]) {
  ...
  for (i = 0; i < ROWS; i++) { /* Finds horizontal wins */
    for (j = 0; j < COLS - 3; j++) {
      if ((temp_board & C4HORIZ << (j + i * COLS)) ==
          C4HORIZ << (j + i * COLS)) {
...
int value(uint64 b1, uint64 b2) {
  ...
  for (k = 0; k < 2; k++) {
    ...
    /***/
    for (i = 0; i < (ROWS - 3) * COLS;
         i++) { /* Finds vertical 3 in a row, that can win */
    ...
    for (i = 0; i < ROWS - 3;
         i++) { /* Finds up_right 3 in a row, that can win */
      for (j = 0; j < COLS - 3; j++) {
    ...
    for (i = 0; i < ROWS - 3;
         i++) { /* Finds up_left 3 in a row, that can win */
      for (j = 0; j < COLS - 3; j++) {
    ...
    /***/
    for (i = 0; i < (ROWS - 3) * COLS;
         i++) { /* Finds vertical 2 in a row, that can win */
    ...
    for (i = 0; i < ROWS - 3;
         i++) { /* Finds up_right 2 in a row, that can win */
      for (j = 0; j < COLS - 3; j++) {
    ...
    for (i = 0; i < ROWS - 3;
         i++) { /* Finds up_left 2 in a row, that can win */
      for (j = 0; j < COLS - 3; j++) {
