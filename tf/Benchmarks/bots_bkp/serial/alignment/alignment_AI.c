...
int diff(int A, int B, int M, int N, int tb, int te, int *print_ptr, int *last_print, int *displ, int seq1, int seq2, int g, int gh) {
  ...
  if (type == 1) {
    ...
    #pragma omp task untied default(shared) depend(inout:A,B,tb,g,print_ptr,last_print,displ,seq1,seq2,g,gh) final(cutoff_test)
    {
    ...
    {
    cutoff_test = (taskminer_depth_cutoff < DEPTH_CUTOFF);
    #pragma omp task untied default(shared) depend(inout:g,te,print_ptr,last_print,displ,seq1,seq2,g,gh) final(cutoff_test)
    {
    ...
    {
    cutoff_test = (taskminer_depth_cutoff < DEPTH_CUTOFF);
    #pragma omp task untied default(shared) depend(inout:A,B,tb,print_ptr,last_print,displ,seq1,seq2,g,gh) final(cutoff_test)
    {
    ...
    {
    cutoff_test = (taskminer_depth_cutoff < DEPTH_CUTOFF);
    #pragma omp task untied default(shared) depend(inout:te,print_ptr,last_print,displ,seq1,seq2,g,gh) final(cutoff_test)
    {
