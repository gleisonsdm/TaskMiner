...
unsigned long long bots_number_of_tasks =
    0; /* forcing 8 bytes size in -m32 and -m64 */
...
#error                                                                         \
    "Default vaule for argument size must be specified (#define BOTS_APP_DEF_ARG_SIZE)"
#endif
#ifndef BOTS_APP_DESC_ARG_SIZE
#error                                                                         \
    "Help description for argument size must be specified (#define BOTS_APP_DESC_ARG_SIZE)"
#endif
...
#error                                                                         \
    "Default vaule for argument size must be specified (#define BOTS_APP_DEF_ARG_SIZE_1)"
#endif
#ifndef BOTS_APP_DESC_ARG_SIZE_1
#error                                                                         \
    "Help description for argument size must be specified (#define BOTS_APP_DESC_ARG_SIZE_1)"
#endif
...
#error                                                                         \
    "Default vaule for argument size must be specified (#define BOTS_APP_DEF_ARG_SIZE_2)"
#endif
#ifndef BOTS_APP_DESC_ARG_SIZE_2
#error                                                                         \
    "Help description for argument size must be specified (#define BOTS_APP_DESC_ARG_SIZE_2)"
#endif
...
#error                                                                         \
    "Default vaule for argument repetitions must be specified (#define BOTS_APP_DEF_ARG_REPETITIONS)"
#endif
#ifndef BOTS_APP_DESC_ARG_REPETITIONS
#error                                                                         \
    "Help description for argument repetitions must be specified (#define BOTS_APP_DESC_ARG_REPETITIONS)"
#endif
...
#error                                                                         \
    "Help description for argument file must be specified (#define BOTS_APP_DESC_ARG_FILE)"
#endif
...
#error                                                                         \
    "Default value for argument block must be specified (#define BOTS_APP_DEF_ARG_BLOCK)"
#endif
#ifndef BOTS_APP_DESC_ARG_BLOCK
#error                                                                         \
    "Help description for argument block must be specified (#define BOTS_APP_DESC_ARG_BLOCK)"
#endif
...
#error                                                                         \
    "Default value for argument cutoff  must be specified (#define BOTS_APP_DEF_ARG_CUTOFF)"
#endif
#ifndef BOTS_APP_DESC_ARG_CUTOFF
#error                                                                         \
    "Help description for argument cutoff must be specified (#define BOTS_APP_DESC_ARG_CUTOFF)"
#endif
...
#error                                                                         \
    "Default value for argument cutoff  must be specified (#define BOTS_APP_DEF_ARG_CUTOFF_1)"
#endif
#ifndef BOTS_APP_DESC_ARG_CUTOFF_1
#error                                                                         \
    "Help description for argument cutoff must be specified (#define BOTS_APP_DESC_ARG_CUTOFF_1)"
#endif
...
#error                                                                         \
    "Default value for argument cutoff  must be specified (#define BOTS_APP_DEF_ARG_CUTOFF_2)"
#endif
#ifndef BOTS_APP_DESC_ARG_CUTOFF_2
#error                                                                         \
    "Help description for argument cutoff must be specified (#define BOTS_APP_DESC_ARG_CUTOFF_2)"
#endif
...
void bots_print_usage() {
  ...
  fprintf(stderr,
          "  -r <value> : Set the number of repetitions (default = 1).\n");
#endif
#ifdef BOTS_APP_USES_ARG_SIZE
  ...
  fprintf(
      stderr,
      "  -z         : Print row header (if output format is a row variant).\n");
  fprintf(stderr, "\n");
  ...
  fprintf(
      stderr,
      "  -c         : Check mode ON (implies running sequential version).\n");
#else
...
/*TODO*/
      ...
      case 'v': /* set/unset verbose level */
        ...
        if (bots_verbose_mode > 1) {
          fprintf(stderr, "Error: Configure the suite using '--debug' option "
                          "in order to use a verbose level greather than 1.\n");
          exit(100);
        }
#endif
        break;
...
void bots_set_info() {
  ...
  snprintf(bots_parameters, BOTS_TMP_STR_SZ,
           BOTS_APP_PARAMETERS_DESC BOTS_APP_PARAMETERS_LIST);
