...
put_image(filename, in, x_size, y_size) char filename[100],
    *in;
int x_size,
    y_size;
{
...
void susan_smoothing(three_by_three, in, dt, x_size, y_size, bp) int three_by_three, x_size, y_size;
uchar *in, *bp;
float dt;
{
  /* {{{ vars */
  ...
  if (three_by_three == 0) {/* large Gaussian masks */
    /* {{{ setup distance lut */
...
#ifdef IGNORETHIS
            if ((b00 & b01) | (b00 & b10) | (b02 & b01) | (b02 & b12) | (b20 & b10) | (b20 & b21) | (b22 & b21) | (b22 & b12)) {/* case; right angle ends. clean up.
