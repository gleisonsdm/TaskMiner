...
void fuloop(void) {
  ...
  while (attempts < attmax) {
    ...
    ll = (blockl > axcenter - numberx) ? (blockl - axcenter) / scalex : ((blockr <= axcenter - numberx) ? (blockr - axcenter) / scalex : (-numberx / scalex));
    rr = (blockr < axcenter + numberx) ? (blockr - axcenter) / scalex : ((blockl >= axcenter + numberx) ? (blockl - axcenter) / scalex : (numberx / scalex));
    bb = (blockb > aycenter - numbery) ? (blockb - aycenter) / scaley : ((blockt <= aycenter - numbery) ? (blockt - aycenter) / scaley : (-numbery / scaley));
    tt = (blockt < aycenter + numbery) ? (blockt - aycenter) / scaley : ((blockb >= aycenter + numbery) ? (blockb - aycenter) / scaley : (numbery / scaley));
