...
*/
{
  ...
  */
  ...
  if (t->t[0][0] == a AND t->t[0][1] == c AND t->t[1][0] == b AND t->t[1][1] == d) {
    MTPopP(t);
    *s = cif;
    return (true);
  } else {
...
int main(void) {
  ...
  LOOP {
    ...
    case 8:
      ...
      if (t->t[0][0] == 1 AND t->t[1][1] == 1 AND t->t[2][2] == 1 AND t->t[0][1] == 0 AND t->t[0][2] == 0 AND t->t[1][0] == 0 AND t->t[1][2] == 0 AND t->t[2][0] == 0 AND t->t[2][1] == 0)
        printf("Yes.\n");
      else
        printf("No.\n");
      MTPopP(t);
