...
DIVISION_TYPE divisions = {{0, 0}, {NFC_0, CENTRAL_0}, {NFC_0, WEST_0}, {NFC_0, CENTRAL_0}, {NFC_0, EAST_0}, {NFC_0, CENTRAL_0}, {NFC_0, CENTRAL_0}, {NFC_0, WEST_0}, {NFC_0, WEST_0}, {NFC_0, EAST_0}, {NFC_0, EAST_0}, {NFC_0, EAST_0}, {NFC_0, WEST_0}, {NFC_0, CENTRAL_0}, {NFC_0, EAST_0}, {AFC_0, EAST_0}, {AFC_0, CENTRAL_0}, {AFC_0, CENTRAL_0}, {AFC_0, WEST_0}, {AFC_0, CENTRAL_0}, {AFC_0, EAST_0}, {AFC_0, WEST_0}, {AFC_0, WEST_0}, {AFC_0, EAST_0}, {AFC_0, EAST_0}, {AFC_0, EAST_0}, {AFC_0, CENTRAL_0}, {AFC_0, WEST_0}, {AFC_0, WEST_0}};
...
int main(int argc, char *argv[]) {
  ...
  if (argc < 2)
    ...
    year = argv[1];
    iyear = str_to_int(year);
    num_games = (((iyear >= 78) && (iyear <= 89)) ? NUM_GAMES_78_89 : NUM_GAMES);
    if (argc == 3)
      in_fileP = 2;
  } else
    argument_error = YES;
