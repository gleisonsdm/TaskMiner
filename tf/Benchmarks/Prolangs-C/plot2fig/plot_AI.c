...
int main(int argc, char *argv[]) {
  ...
  for (i = 1; i < argc; i++) {
    if ((strcmp(argv[i], "-fontsize") == 0) || (strcmp(argv[i], "-fs") == 0)) {
      ...
      i += 1;
    } else if ((strcmp(argv[i], "-fontname") == 0) || (strcmp(argv[i], "-fn") == 0)) {
      fontname(argv[i + 1]);
      i += 1;
    } else if ((strcmp(argv[i], "-high-byte-first") == 0) || (strcmp(argv[i], "-h") == 0)) {
      guess_byte_order = 0;
      high_byte_first = 1;
    } else if ((strcmp(argv[i], "-low-byte-first") == 0) || (strcmp(argv[i], "-l") == 0)) {
      guess_byte_order = 0;
      high_byte_first = 0;
    } else if ((strcmp(argv[i], "-warranty") == 0) || (strcmp(argv[i], "-copying") == 0)) {
      /*
