...
int32 WriteViewToDisk(ADC_VIEW_CNTL *avp, treeNode *t) {
  ...
  #pragma omp task untied default(shared) depend(in:t) depend(inout:avp) final(cutoff_test)
  {
  ...
  {
  cutoff_test = (taskminer_depth_cutoff < DEPTH_CUTOFF);
  #pragma omp task untied default(shared) depend(in:t[0][1]) depend(inout:avp) final(cutoff_test)
  {
...
int32 WriteViewToDiskCS(ADC_VIEW_CNTL *avp, treeNode *t, uint64 *ordern) {
  ...
  {
  cutoff_test = (taskminer_depth_cutoff < DEPTH_CUTOFF);
  #pragma omp task untied default(shared) depend(in:t) depend(inout:avp,ordern) final(cutoff_test)
  {
  ...
  {
  cutoff_test = (taskminer_depth_cutoff < DEPTH_CUTOFF);
  #pragma omp task untied default(shared) depend(in:t[0][1]) depend(inout:avp,ordern) final(cutoff_test)
  {
...
int32 WriteChunkToDisk(uint32 recordSize, FILE *fileOfChunks,
  ...
  {
  cutoff_test = (taskminer_depth_cutoff < DEPTH_CUTOFF);
  #pragma omp task untied default(shared) depend(in:t) depend(inout:fileOfChunks,logFile) final(cutoff_test)
  {
  ...
  {
  cutoff_test = (taskminer_depth_cutoff < DEPTH_CUTOFF);
  #pragma omp task untied default(shared) depend(in:t[0][1]) depend(inout:fileOfChunks,logFile) final(cutoff_test)
  {
