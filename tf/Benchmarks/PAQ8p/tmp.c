...
Recommended compiler commands and optimizations:
  ...
  MINGW g++:
    ...
    g++ paq8p.cpp -DWINDOWS -O2 -Os -s -march=pentiumpro -fomit-frame-pointer -o
paq8p.exe paq7asm.obj
  ...
  UNIX/Linux (PC):
    ...
    g++ paq8p.cpp -DUNIX -O2 -Os -s -march=pentiumpro -fomit-frame-pointer -o
paq8p paq7asm.o
...
void quit(const char *message = 0) { throw message; }
...
public:
  ...
  String(const char *s = "") : Array<char>(1) { (*this) += s; }
};
...
public:
  IntBuf(int i = 0) : b(i) {}
  int &operator[](int i) { return b[i & b.size() - 1]; }
};
...
static const U8 State_table[256][4] = {
    {1, 2, 0, 0},      {3, 5, 1, 0},
    {4, 6, 0, 1},      {7, 10, 2, 0}, // 0-3
    {8, 12, 1, 1},     {9, 13, 1, 1},
    {11, 14, 0, 2},    {15, 19, 3, 0}, // 4-7
    {16, 23, 2, 1},    {17, 24, 2, 1},
    {18, 25, 2, 1},    {20, 27, 1, 2}, // 8-11
    {21, 28, 1, 2},    {22, 29, 1, 2},
    {26, 30, 0, 3},    {31, 33, 4, 0}, // 12-15
    {32, 35, 3, 1},    {32, 35, 3, 1},
    {32, 35, 3, 1},    {32, 35, 3, 1}, // 16-19
    {34, 37, 2, 2},    {34, 37, 2, 2},
    {34, 37, 2, 2},    {34, 37, 2, 2}, // 20-23
    {34, 37, 2, 2},    {34, 37, 2, 2},
    {36, 39, 1, 3},    {36, 39, 1, 3}, // 24-27
    {36, 39, 1, 3},    {36, 39, 1, 3},
    {38, 40, 0, 4},    {41, 43, 5, 0}, // 28-31
    {42, 45, 4, 1},    {42, 45, 4, 1},
    {44, 47, 3, 2},    {44, 47, 3, 2}, // 32-35
    {46, 49, 2, 3},    {46, 49, 2, 3},
    {48, 51, 1, 4},    {48, 51, 1, 4}, // 36-39
    {50, 52, 0, 5},    {53, 43, 6, 0},
    {54, 57, 5, 1},    {54, 57, 5, 1}, // 40-43
    {56, 59, 4, 2},    {56, 59, 4, 2},
    {58, 61, 3, 3},    {58, 61, 3, 3}, // 44-47
    {60, 63, 2, 4},    {60, 63, 2, 4},
    {62, 65, 1, 5},    {62, 65, 1, 5}, // 48-51
    {50, 66, 0, 6},    {67, 55, 7, 0},
    {68, 57, 6, 1},    {68, 57, 6, 1}, // 52-55
    {70, 73, 5, 2},    {70, 73, 5, 2},
    {72, 75, 4, 3},    {72, 75, 4, 3}, // 56-59
    {74, 77, 3, 4},    {74, 77, 3, 4},
    {76, 79, 2, 5},    {76, 79, 2, 5}, // 60-63
    {62, 81, 1, 6},    {62, 81, 1, 6},
    {64, 82, 0, 7},    {83, 69, 8, 0}, // 64-67
    {84, 71, 7, 1},    {84, 71, 7, 1},
    {86, 73, 6, 2},    {86, 73, 6, 2}, // 68-71
    {44, 59, 5, 3},    {44, 59, 5, 3},
    {58, 61, 4, 4},    {58, 61, 4, 4}, // 72-75
    {60, 49, 3, 5},    {60, 49, 3, 5},
    {76, 89, 2, 6},    {76, 89, 2, 6}, // 76-79
    {78, 91, 1, 7},    {78, 91, 1, 7},
    {80, 92, 0, 8},    {93, 69, 9, 0}, // 80-83
    {94, 87, 8, 1},    {94, 87, 8, 1},
    {96, 45, 7, 2},    {96, 45, 7, 2}, // 84-87
    {48, 99, 2, 7},    {48, 99, 2, 7},
    {88, 101, 1, 8},   {88, 101, 1, 8}, // 88-91
    {80, 102, 0, 9},   {103, 69, 10, 0},
    {104, 87, 9, 1},   {104, 87, 9, 1}, // 92-95
    {106, 57, 8, 2},   {106, 57, 8, 2},
    {62, 109, 2, 8},   {62, 109, 2, 8}, // 96-99
    {88, 111, 1, 9},   {88, 111, 1, 9},
    {80, 112, 0, 10},  {113, 85, 11, 0}, // 100-103
    {114, 87, 10, 1},  {114, 87, 10, 1},
    {116, 57, 9, 2},   {116, 57, 9, 2}, // 104-107
    {62, 119, 2, 9},   {62, 119, 2, 9},
    {88, 121, 1, 10},  {88, 121, 1, 10}, // 108-111
    {90, 122, 0, 11},  {123, 85, 12, 0},
    {124, 97, 11, 1},  {124, 97, 11, 1}, // 112-115
    {126, 57, 10, 2},  {126, 57, 10, 2},
    {62, 129, 2, 10},  {62, 129, 2, 10}, // 116-119
    {98, 131, 1, 11},  {98, 131, 1, 11},
    {90, 132, 0, 12},  {133, 85, 13, 0}, // 120-123
    {134, 97, 12, 1},  {134, 97, 12, 1},
    {136, 57, 11, 2},  {136, 57, 11, 2}, // 124-127
    {62, 139, 2, 11},  {62, 139, 2, 11},
    {98, 141, 1, 12},  {98, 141, 1, 12}, // 128-131
    {90, 142, 0, 13},  {143, 95, 14, 0},
    {144, 97, 13, 1},  {144, 97, 13, 1}, // 132-135
    {68, 57, 12, 2},   {68, 57, 12, 2},
    {62, 81, 2, 12},   {62, 81, 2, 12}, // 136-139
    {98, 147, 1, 13},  {98, 147, 1, 13},
    {100, 148, 0, 14}, {149, 95, 15, 0}, // 140-143
    {150, 107, 14, 1}, {150, 107, 14, 1},
    {108, 151, 1, 14}, {108, 151, 1, 14}, // 144-147
    {100, 152, 0, 15}, {153, 95, 16, 0},
    {154, 107, 15, 1}, {108, 155, 1, 15}, // 148-151
    {100, 156, 0, 16}, {157, 95, 17, 0},
    {158, 107, 16, 1}, {108, 159, 1, 16}, // 152-155
    {100, 160, 0, 17}, {161, 105, 18, 0},
    {162, 107, 17, 1}, {108, 163, 1, 17}, // 156-159
    {110, 164, 0, 18}, {165, 105, 19, 0},
    {166, 117, 18, 1}, {118, 167, 1, 18}, // 160-163
    {110, 168, 0, 19}, {169, 105, 20, 0},
    {170, 117, 19, 1}, {118, 171, 1, 19}, // 164-167
    {110, 172, 0, 20}, {173, 105, 21, 0},
    {174, 117, 20, 1}, {118, 175, 1, 20}, // 168-171
    {110, 176, 0, 21}, {177, 105, 22, 0},
    {178, 117, 21, 1}, {118, 179, 1, 21}, // 172-175
    {110, 180, 0, 22}, {181, 115, 23, 0},
    {182, 117, 22, 1}, {118, 183, 1, 22}, // 176-179
    {120, 184, 0, 23}, {185, 115, 24, 0},
    {186, 127, 23, 1}, {128, 187, 1, 23}, // 180-183
    {120, 188, 0, 24}, {189, 115, 25, 0},
    {190, 127, 24, 1}, {128, 191, 1, 24}, // 184-187
    {120, 192, 0, 25}, {193, 115, 26, 0},
    {194, 127, 25, 1}, {128, 195, 1, 25}, // 188-191
    {120, 196, 0, 26}, {197, 115, 27, 0},
    {198, 127, 26, 1}, {128, 199, 1, 26}, // 192-195
    {120, 200, 0, 27}, {201, 115, 28, 0},
    {202, 127, 27, 1}, {128, 203, 1, 27}, // 196-199
    {120, 204, 0, 28}, {205, 115, 29, 0},
    {206, 127, 28, 1}, {128, 207, 1, 28}, // 200-203
    {120, 208, 0, 29}, {209, 125, 30, 0},
    {210, 127, 29, 1}, {128, 211, 1, 29}, // 204-207
    {130, 212, 0, 30}, {213, 125, 31, 0},
    {214, 137, 30, 1}, {138, 215, 1, 30}, // 208-211
    {130, 216, 0, 31}, {217, 125, 32, 0},
    {218, 137, 31, 1}, {138, 219, 1, 31}, // 212-215
    {130, 220, 0, 32}, {221, 125, 33, 0},
    {222, 137, 32, 1}, {138, 223, 1, 32}, // 216-219
    {130, 224, 0, 33}, {225, 125, 34, 0},
    {226, 137, 33, 1}, {138, 227, 1, 33}, // 220-223
    {130, 228, 0, 34}, {229, 125, 35, 0},
    {230, 137, 34, 1}, {138, 231, 1, 34}, // 224-227
    {130, 232, 0, 35}, {233, 125, 36, 0},
    {234, 137, 35, 1}, {138, 235, 1, 35}, // 228-231
    {130, 236, 0, 36}, {237, 125, 37, 0},
    {238, 137, 36, 1}, {138, 239, 1, 36}, // 232-235
    {130, 240, 0, 37}, {241, 125, 38, 0},
    {242, 137, 37, 1}, {138, 243, 1, 37}, // 236-239
    {130, 244, 0, 38}, {245, 135, 39, 0},
    {246, 137, 38, 1}, {138, 247, 1, 38}, // 240-243
    {140, 248, 0, 39}, {249, 135, 40, 0},
    {250, 69, 39, 1},  {80, 251, 1, 39}, // 244-247
    {140, 252, 0, 40}, {249, 135, 41, 0},
    {250, 69, 40, 1},  {80, 251, 1, 40}, // 248-251
...
template <int B> inline U8 *BH<B>::operator[](U32 i) {
...
ContextMap::ContextMap(int m, int c)
    : C(c), t(m >> 6), cp(c), cp0(c), cxt(c), runp(c), cn(0) {
...
ContextMap::~ContextMap() { delete[] sm; }
...
int ContextMap::mix1(Mixer &m, int cc, int bp, int c1, int y1) {
  ...
  for (int i = 0; i < cn; ++i) {
    ...
    if (runp[i][1] + 256 >> 8 - bp == cc) {
      ...
      int b =
          (runp[i][1] >> 7 - bp & 1) * 2 - 1; // predicted bit + for 1, - for 0
...
#if 1
    int r = pos - cpos1[c];
    if (r > 1 && r == cpos1[c] - cpos2[c] && r == cpos2[c] - cpos3[c] &&
        r == cpos3[c] - cpos4[c] &&
...
int bmpModel(Mixer &m) {
  ...
  static SmallStationaryContextMap scm1(SC), scm2(SC), scm3(SC), scm4(SC),
      scm5(SC), scm6(SC), scm7(SC), scm8(SC), scm9(SC * 2), scm10(SC);
  static ContextMap cm(MEM * 4, 13);

  // Detect .bmp file header (24 bit color, not compressed)
  if (!bpos && buf(54) == 'B' && buf(53) == 'M' && i4(44) == 54 &&
      i4(40) == 40 && i4(24) == 0) {
...
void model8bit(Mixer &m, int w) {
  ...
  if (!bpos) {
    ...
    const int var = sqrbuf(1) + sqrbuf(w - 1) + sqrbuf(w) + sqrbuf(w + 1) -
                        mean * mean / 4 >>
                    2;
    mean >>= 2;
    const int logvar = ilog(var);
    ...
    cm.set(hash(++i, buf(2) + buf(1) >> 1, buf(w + 1) + buf(w * 2 + 2) >> 1));
    cm.set(
        hash(++i, buf(w) + buf(w * 2) >> 1, buf(w - 1) + buf(w * 2 + 2) >> 1));
...
int pgmModel(Mixer &m) {
  ...
  if (!bpos) {
    if (buf(3) == 'P' && buf(2) == '5' && ISWHITESPACE(1)) // Detect PGM file
    {
      pgm = pos;
      pgm_ptr = 0;
      return w = 0; // PGM header just detected, not enough info to get header
                    // yet
...
int bmpModel8(Mixer &m) {
  ...
  if (bpos == 0) {
    //  8-bit .bmp images                    data offset      windows bmp
    //  compression   bpp
    if (/*buf(54)=='B' && buf(53)=='M' && */ (i4(44) < 1079) && i4(40) == 40 &&
        i4(24) == 0 && (buf(26) == 8 /*| buf(26)==4)*/)) {
      /*	if  (buf(26)==4)
...
int jpegModel(Mixer &m) {
  ...
  const static U8 zzv[64] = {0, 0, 1, 2, 1, 0, 0, 1, 2, 3, 4, 3, 2, 1, 0, 0,
        ...
        if (huffsize + (rs & 15) == huffbits) { // done decoding
          ...
          // UPDATE_ADV_PRED !!!!
          {
            ...
            if (zz == 0) {
              ...
              for (int i = 0; i < 64; i++) {
                sumu2[zzu[i]] += we[zzv[i]] * (zzv[i] & 1 ? -1 : +1) *
                                 (qtab[q + i] + 1) *
                                 cbuf2[cpos_dc_mcusize_width + i];
                sumv2[zzv[i]] += we[zzu[i]] * (zzu[i] & 1 ? -1 : +1) *
                                 (qtab[q + i] + 1) *
                                 cbuf2[cpos_dc_ls_acomp + i];
                sumu3[zzu[i]] += (zzv[i] ? (zzv[i] & 1 ? -256 : 256) : 181) *
                                 (qtab[q + i] + 1) *
                                 cbuf2[cpos_dc_mcusize_width + i];
                sumv3[zzv[i]] += (zzu[i] ? (zzu[i] & 1 ? -256 : 256) : 181) *
                                 (qtab[q + i] + 1) *
                                 cbuf2[cpos_dc_ls_acomp + i];
              }
            } else {
              sumu2[zzu[zz - 1]] -=
                  we[zzv[zz - 1]] * (qtab[q + zz - 1] + 1) * cbuf2[cpos - 1];
              sumv2[zzv[zz - 1]] -=
                  we[zzu[zz - 1]] * (qtab[q + zz - 1] + 1) * cbuf2[cpos - 1];
              sumu3[zzu[zz - 1]] -= (zzv[zz - 1] ? 256 : 181) *
                                    (qtab[q + zz - 1] + 1) * cbuf2[cpos - 1];
              sumv3[zzv[zz - 1]] -= (zzu[zz - 1] ? 256 : 181) *
                                    (qtab[q + zz - 1] + 1) * cbuf2[cpos - 1];
            }
            for (int i = 0; i < 8; ++i) {
              int k = kx[i];
            ...
            for (int i = 0; i < 4; ++i) {
              ...
              if (a < b)
                ...
                const int zz2 =
                    zpos[zzu[zz] + 8 * zzv[zz] - (i & 1 ? 8 : 1) * b];
                x = (qtab[q + zz2] + 1) * cbuf2[cpos_dc + zz2] /
                    (qtab[q + zz] + 1);
  ...
  if (hbcount == 0) {
    ...
    cxt[15] = hash(++n, hc, column >> 2, lcp[0] + 256 * (lcp[2] / 3),
                   lcp[1] + 256 * (lcp[3] / 3));
...
// Based on 'An asymptotically Optimal Predictor for Stereo Lossless Audio
// Compression'
// by Florin Ghido.
...
int wavModel(Mixer &m) {
  ...
  const int SC = 0x20000;
  static SmallStationaryContextMap scm1(SC), scm2(SC), scm3(SC), scm4(SC),
      scm5(SC), scm6(SC), scm7(SC), scm8(SC);
  static ContextMap cm(MEM * 4, 10);

  // Detect .wav file header
  if (!bpos && buf(8) == 'd' && buf(7) == 'a' && buf(6) == 't' &&
      buf(5) == 'a') {
    for (int i = 32; i <= 1000; i++)
      if (buf(i) == 'f' && buf(i - 1) == 'm' && buf(i - 2) == 't' &&
          buf(i - 3) == ' ' && (i2(i - 8) == 1 || i2(i - 8) == 65534)) {
        bits = buf(i - 22);
        bytes = bits + 7 >> 3;
        channels = buf(i - 10);
        w = channels * bytes;
  ...
  if (!bpos) {
    ...
    if (!msb) {
      ...
      if (++n[chn] == K) {
        if (channels == 1)
          for (k = 1; k <= S + D; k++)
            for (l = k; l <= S + D; l++)
              F[k][l][chn] =
                  (F[k - 1][l - 1][chn] - X(k - 1, 1) * X(l - 1, 1)) / a;
        else
          for (k = 1; k <= S + D; k++)
            if (k != S + 1)
              for (l = k; l <= S + D; l++)
      ...
      cm.set(hash(++i, pr[0][chn] & 0xff,
                  (s2(w) - pr[1][chn] + s2(w * 2) - pr[2][chn] >> 1) & 0xff,
                  ch));
      cm.set(hash(++i, pr[0][chn] + s2(w) * 2 - pr[1][chn] * 2 - s2(w * 2) +
                               pr[2][chn] &
                           0xff,
                  ch));
      scm1.set(s2(w) & 0x1ff);
      ...
      cm.set(hash(++i, c(4, w, w * 2, w * 3, w * 4),
                  c(3, w * 5, w * 6, w * 7, w * 8),
                  c(2, w * 9, w * 10, w * 11, w * 12), ch));
      cm.set(hash(++i, c(2, w, w * 2, w * 3, w * 4) << 8 |
                           c(2, w * 5, w * 6, w * 7, w * 8),
                  c(2, w * 9, w * 10, w * 11, w * 12) << 8 |
                      c(2, w * 13, w * 14, w * 15, w * 16),
                  c(2, w * 17, w * 18, w * 19, w * 20) << 8 |
                      c(2, w * 21, w * 22, w * 23, w * 24),
                  ch));
      cm.set(hash(++i, pr[0][chn] >> 8, ch));
      cm.set(hash(++i, pr[0][chn] + s2(w + 1) - pr[1][chn] >> 8, ch));
      cm.set(hash(++i, pr[0][chn] >> 8,
                  s2(w + 1) - pr[1][chn] + s2(w * 2 + 1) - pr[2][chn] >> 9,
                  ch));
      cm.set(hash(++i, pr[0][chn] + s2(w + 1) * 2 - pr[1][chn] * 2 -
                               s2(w * 2 + 1) + pr[2][chn] >>
                           8,
                  ch));
      ...
      scm7.set(s2(w + 1) * 4 - s2(w * 2 + 1) * 6 + s2(w * 3 + 1) * 4 -
                   s2(w * 4 + 1) - buf(1) >>
               7);
      scm8.set(s2(w + 1) * 5 - s2(w * 2 + 1) * 10 + s2(w * 3 + 1) * 10 -
                   s2(w * 4 + 1) * 5 + s2(w * 5 + 1) - buf(1) + pr[0][chn] >>
               9);
    }
  }
...
U32 execxt(int i, int x = 0) {
  int prefix = (buf(i + 2) == 0x0f) + 2 * (buf(i + 2) == 0x66) +
               3 * (buf(i + 2) == 0x67) + 4 * (buf(i + 3) == 0x0f) +
               8 * (buf(i + 3) == 0x66) + 12 * (buf(i + 3) == 0x67);
  int opcode = buf(i + 1);
...
int contextModel2() {
  ...
  int iswav = wavModel(
      m); // number of channels and bits per sample if WAV is detected, else 0
  if (filetype == JPEG) {
  ...
  if (filetype == BMPFILE24 || filetype == TIFFFILE) {
    int isbmp =
        bmpModel(m); // Image width (bytes) if BMP or TIFF detected, or 0
    if (isbmp > 0) {
      static int col = 0;
      if (++col >= 24)
        col = 0;
  ...
  if (filetype == PGMFILE) {
    if (pgmModel(m) > 0)
      return m.p(); // Image width (bytes) if PGM (P5,PGM_MAXVAL = 255)
                    // detected, or 0
  }
  ...
  m.set(c1 + 8, 264);
  m.set(c0, 256);
  m.set(order + 8 * (c4 >> 5 & 7) + 64 * (c1 == c2) + 128 * (filetype == EXE),
        256);
  m.set(c2, 256);
  m.set(c3, 256);
  m.set(ismatch, 256);
...
void Predictor::update() {
  static APM1 a(256), a1(0x10000), a2(0x10000), a3(0x10000), a4(0x10000),
      a5(0x10000), a6(0x10000);
...
Filetype detect(FILE *in, int n, Filetype type) {
  ...
  // For BMP detection
  int bmp = 0, bmp0 = 0, bsize = 0, imgbpp = 0, bmpx = 0, bmpy = 0,
      bmpimgoff = 0, imgcomp = -1;
  // For PGM detection
  int pgm = 0, psize = 0, pgmcomment = 0, pgmw = 0, pgmh = 0, pgmsize = 0,
      pgm_ptr = 0, pgmc = 0;
  char pgm_buf[32];
  // For JPEG detection
  int soi = 0, sof = 0, sos = 0, app = 0; // position where found
  // For .RGB detection
  int rgbi = 0, rgbSTORAGE = -1, rgbBPC = 0, rgbDIMENSION = 0, rgbZSIZE = 0,
      rgbXSIZE = 0, rgbYSIZE = 0, rgbsize = 0;
  for (int i = 0; i < n; ++i) {
    int c = getc(in);
    if (c == EOF)
      return (Filetype)(-1);
    ...
    if (!soi && i >= 3 && (buf0 & 0xfffffff0) == 0xffd8ffe0)
      soi = i, app = i + 2;
    if (soi) {
      if (app == i && ((buf0 & 0xfff00000) == 0xffe00000 ||
                       (buf0 & 0xffff0000) == 0xfffe0000))
        app = i + (buf0 & 0xffff) + 2;
    ...
    if (rgbi) {
      if ((i - rgbi) == 1)
        if (c == 0 || c == 1)
          ...
          rgbi = rgbBPC = rgbDIMENSION = rgbZSIZE = rgbXSIZE = rgbYSIZE = 0,
          rgbSTORAGE = -1;
      if ((i - rgbi) == 2)
        if (c == 1 || c == 2)
          rgbBPC = c;
          ...
          rgbSTORAGE = -1;
      if ((i - rgbi) == 4)
        if ((buf0 & 0xFFFF) == 1 || (buf0 & 0xFFFF) == 2 ||
            (buf0 & 0xFFFF) == 3)
      ...
      if ((i - rgbi) == 8)
        if ((buf0 & 0xFFFF) > 0)
          ...
          rgbSTORAGE = -1;
      if ((i - rgbi) == 10)
        if ((buf0 & 0xFFFF) == 1 || (buf0 & 0xFFFF) == 3 ||
            (buf0 & 0xFFFF) == 4) // 1 indicates greyscale
                                  // 3 indicates RGB
      ...
      if (rgbsize != 0 && (i - rgbi) > 0 && ((i - rgbi) > rgbsize)) {
        if (type == RGBFILE && rgbZSIZE == 1 &&
            rgbSTORAGE == 0) { // uncompressed greyscale
...
int decode_default(Encoder &en) { return en.decompress(); }
...
int decode_jpeg(Encoder &en) { return en.decompress(); }
// BMP encode as self.
...
int decode_bmp(Encoder &en) { return en.decompress(); }
...
int decode_pgm(Encoder &en) { return en.decompress(); }
...
int decode_rgb(Encoder &en) { return en.decompress(); }
...
void encode_exe(FILE *in, FILE *out, int len, int begin) {
  ...
  Array<U8> blk(BLOCK);
  fprintf(out, "%c%c%c%c", len >> 24, len >> 16, len >> 8,
          len); // size, MSB first
  ...
  for (int offset = 0; offset < len; offset += BLOCK) {
    ...
    for (int i = bytesRead - 1; i >= 4; --i) {
      if ((blk[i - 4] == 0xe8 || blk[i - 4] == 0xe9) &&
          (blk[i] == 0 || blk[i] == 0xff)) {
        int a =
            (blk[i - 3] | blk[i - 2] << 8 | blk[i - 1] << 16 | blk[i] << 24) +
            offset + begin + i + 1;
        a <<= 7;
        a >>= 7;
        blk[i] = a >> 24;
...
int decode_exe(Encoder &en) {
  ...
  if (q == 5 && (c[4] == 0xe8 || c[4] == 0xe9) && (c[0] == 0 || c[0] == 0xff) &&
      ((offset - 1 ^ offset - 5) & -BLOCK) ==
          0) { // not crossing block boundary
...
int paqmain(int argc, char **argv) {
  ...
  try {
    ...
    if (argc < 2) {
      printf(
          PROGNAME
          " archiver (C) 2008, Matt Mahoney et al.\n"
          "Free under GPL, http://www.gnu.org/licenses/gpl.txt\n\n"
#ifdef WINDOWS
          "To compress or extract, drop a file or folder on the " PROGNAME
          " icon.\n"
          ...
          "To compress:\n"
          "  " PROGNAME
          " -level file               (compresses to file." PROGNAME ")\n"
          "  " PROGNAME " -level archive files...   (creates archive." PROGNAME
          ")\n"
          "  " PROGNAME
          " file                      (level -%d, pause when done)\n"
          ...
          "  " PROGNAME " archive." PROGNAME
          "              (extract, pause when done)\n"
          "\n"
    ...
    String archiveName(mybasename(argv[1]));
    {
      ...
      if (arg1size > prognamesize + 1 &&
          argv[1][arg1size - prognamesize - 1] == '.' &&
