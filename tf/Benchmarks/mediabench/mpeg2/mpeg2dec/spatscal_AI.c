...
static void Make_Spatial_Prediction_Frame(progressive_frame,
                                          ...
                                          vertical_size, vm, vn, hm, hn, aperture) int progressive_frame,
    llprogressive_frame;
 ...
 */
static void Deinterlace(fld0, fld1, j0, lx, ly, aperture) unsigned char *fld0, *fld1;
...
/* vertical resampling */
static void Subsample_Vertical(s, d, lx, lys, lyd, m, n, j0, dj) unsigned char *s;
short *d;
