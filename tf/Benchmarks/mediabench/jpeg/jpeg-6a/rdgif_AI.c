...
start_input_gif(j_compress_ptr cinfo, cjpeg_source_ptr sinfo) {
  ...
  source->symbol_head = (UINT16 FAR *)(*cinfo->mem->alloc_large)((j_common_ptr)cinfo, JPOOL_IMAGE,
                                                                 LZW_TABLE_SIZE * SIZEOF(UINT16));
  source->symbol_tail = (UINT8 FAR *)(*cinfo->mem->alloc_large)((j_common_ptr)cinfo, JPOOL_IMAGE,
                                                                LZW_TABLE_SIZE * SIZEOF(UINT8));
  source->symbol_stack = (UINT8 FAR *)(*cinfo->mem->alloc_large)((j_common_ptr)cinfo, JPOOL_IMAGE,
                                                                 LZW_TABLE_SIZE * SIZEOF(UINT8));
  InitLZWCode(source);
  ...
  if (source->is_interlaced) {
     ...
     */
    source->interlaced_image = (*cinfo->mem->request_virt_sarray)((j_common_ptr)cinfo, JPOOL_IMAGE, FALSE,
...
load_interlaced_image(j_compress_ptr cinfo, cjpeg_source_ptr sinfo) {
  ...
  for (row = 0; row < cinfo->image_height; row++) {
    ...
    image_ptr = (*cinfo->mem->access_virt_sarray)((j_common_ptr)cinfo, source->interlaced_image,
...
jinit_read_gif(j_compress_ptr cinfo) {
  ...
  source = (gif_source_ptr) (*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE,
